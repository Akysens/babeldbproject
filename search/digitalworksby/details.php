...
<body>
    ...
    <div class="card-wrapper search-result-card">
        ...
        <?php
            ...
            $sql = "SELECT Media.mid, Media.title, Media.genre, Media.datePublished,
                    DigitalMedia.downloadInfo From Media
                    INNER JOIN DigitalMedia on Media.mid = DigitalMedia.mid
                    LEFT JOIN Audio on DigitalMedia.mid=Audio.mid
                    LEFT JOIN Games on DigitalMedia.mid=Games.mid
                    LEFT JOIN Text on DigitalMedia.mid=Text.mid
                    LEFT JOIN Video on DigitalMedia.mid=Video.mid
                    WHERE Media.mid = " . $r_mid . ";";
            ...
            if ($result) {
                if($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . (($row["downloadinfo"] == 1) ? "Yes":"No"). "</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                }
