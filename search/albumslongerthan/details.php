...
<body>
    ...
    <div class="card-wrapper search-result-card">
        ...
        <?php
            ...
            $sql = "SELECT Media.mid, Media.title, Media.genre, Media.datePublished, PhysicalMedia.available, 
                    DiscsAndTapes.producer, DiscsAndTapes.label, DiscsAndTapes.duration FROM Media
