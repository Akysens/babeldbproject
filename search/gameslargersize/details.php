...
<body>
    ...
    <div class="card-wrapper search-result-card">
        ...
        <?php
            ...
            $sql = "SELECT Media.mid, Media.title, Media.genre, Media.datePublished, DigitalMedia.downloadInfo, 
                    Games.creator, Games.fileSize FROM Media
                    INNER JOIN DigitalMedia on DigitalMedia.mid = Media.mid
                    INNER JOIN Games on Games.mid = DigitalMedia.mid
